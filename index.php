...
<body>
    ...
    <nav class="navbar">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#teams">Serviços</a>
        </li>
        <li class="nav-item">
 ...
 <section class="teams" id="teams">
    <h2 class="title"style="padding-bottom: 52px;">Meus Serviços</h2>
    ...
    <div class="carousel owl-carousel">
        <div class="card">
            <div class="box">
                ...
                <div class="text">Formatação</div>
                <p>Formatação de computadores e Instalação de software. </p>
            </div>
        </div>
        <div class="card">
            <div class="box">
                ...
                <div class="text">Criação de Sites</div>
                <p> Desenho e toda a construção pagina do sites.</p>
            </div>
        </div>
        <div class="card">
            <div class="box">
                ...
                <div class="text">Manuntenções</div>
                <p> Manutenção e implementação funcionalidades.</p>
            </div>
          </div>
        </div>
    </section>
            ...
            <div class="carousel owl-carousel">
                <div class="card">
                    <div class="box">
                        ...
                        <p>Todos os meus projetos você encontra aqui.</p>
                    </div>
                </div>      
            </section>
